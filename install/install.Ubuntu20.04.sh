...
sudo apt install --assume-yes python-dev python3-pip python3-pil python3-opencv python3-rrdtool python3-configobj python3-setuptools python3-psutil python3-dateutil python3-numpy
